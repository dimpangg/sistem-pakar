...
const Button = ({ children, className, isLoading, ...rest }: ButtonProps) => {
  return (
    <button
      disabled={isLoading || rest.disabled}
      className={classNames(
        "rounded-md bg-slate-900 px-4 py-2 text-body-medium text-white hover:bg-slate-700 disabled:bg-slate-900/50",
      ...
      {isLoading && (
        ...
        >
          ...
          <path
            ...
            stroke="white"
            strokeWidth="2"
            mask="url(#path-1-inside-1_2_268)"
          />
        </svg>
      )}
      {children}
